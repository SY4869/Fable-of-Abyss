...
var DIFFS=[
  {k:'normal',n:'ノーマル',lat:'NORMAL',bs:0.86,bhp:0.78,ehp:0.78,eden:1.28,ex:0,bomb:3,inv:140,
   d:'弾は遅く、ボスの体力も少なめ。まずは5つの寓話を最後まで読み通すための難易度。'},
  ...
  {k:'extra',n:'エクストラ',lat:'EXTRA',bs:1.13,bhp:1.16,ehp:1.22,eden:0.56,ex:1,bomb:1,inv:96,
   d:'弾速も体力も増し、道中の敵は一層厚い。ボスは幾つかの弾幕が別物に変わる。ボムは1つきり。現在調整中のため非推奨。'}
];
var DF=DIFFS[1];
...
var BOMBS=[
  {k:'grim',n:'グリムリープ',lat:'GRIM LEAP',sec:3,dur:180,
   d:'現在地に影武者を残し、3秒のあいだ無敵で疾走する。敵の狙撃は影武者へ逸れ、走り抜けた軌跡が弾を焼き払い続ける。時間切れの瞬間、自分と影武者の両方を中心に大爆発が起こる。'},
  {k:'stop',n:'タイムストップ',lat:'TIME STOP',sec:5,dur:300,
   d:'5秒間、敵と自分の弾幕をまとめて止める。止まった弾には当たらない。自分の弾も止まるが、解除の瞬間に溜まった分が一斉に走り出す。'},
  {k:'excal',n:'エクスカリバー',lat:'EXCALIBUR',sec:1,dur:60,
   d:'1秒だけ真上へ極太の光を放つ。触れた弾幕は残らず消え、貫かれ続けたものは深く抉られる。ボムの中で最も火力が高い。'},
  {k:'hollow',n:'ホロウエクリプス',lat:'HOLLOW ECLIPSE',sec:3,dur:180,
   d:'3秒間、相手の弾幕を湧いた端から消し続ける。攻撃力は無いが、どんな弾幕でも3秒だけは無かったことにできる。'},
  {k:'light',n:'ライトニングリパルサー',lat:'LIGHTNING REPULSOR',sec:3,dur:180,
   d:'3秒間、高速で動けるようになり、掠り範囲に入った弾を相手へ撃ち返す。濃い弾幕に踏み込むほど返る火力が伸びる、上級者向けの一手。'}
];
